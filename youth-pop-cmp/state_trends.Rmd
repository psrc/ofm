...
plot.actual <- ggplot(df.youth, aes(x = Year, y = total_youth)) +
  geom_line() +
  ...
  labs(y = 'Total',
       ...
       subtitle = 'Persons from ages 5-17')
...
plot.growth <- ggplot(df.youth.bar, aes(x = as.factor(Year), y = share_growth)) +
  geom_col() +
...
ggplot(df.group, aes(x = Year, y = total, color = age_group)) +
  ...
  labs(y = 'Total',
       ...
       subtitle = 'Persons from ages 5-19')
